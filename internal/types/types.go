...
const (
	...
	BitxhubUrlLinux = "https://github.com/meshplus/bitxhub/releases/download/v1.0.0-rc1/bitxhub_linux_amd64.tar.gz"
	BitxhubUrlMacOS = "https://github.com/meshplus/bitxhub/releases/download/v1.0.0-rc1/bitxhub_macos_x86_64.tar.gz"

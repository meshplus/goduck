...
function deploy_contracts() {
   print_blue "Deploy broker contract1"
   ...
   print_green "broker contract address1: $broker_address"

   print_blue "Deploy transfer contract1"
   ...
   print_green "transfer contract address1: $transfer_address"
   ...
   print_blue "Deploy broker contract2"
   ...
   print_green "broker contract address2: $broker_address2"

   print_blue "Deploy transfer contract2"
   ...
   print_green "transfer contract address2: $transfer_address2"

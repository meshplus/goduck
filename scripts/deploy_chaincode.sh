...
function installInterchainChaincode() {
  ...
  if [ "${TYPE}" == "direct" ]; then
    ...
    docker exec cli peer chaincode invoke -o orderer.example.com:7050 \
          ...
          --peerAddresses peer0.org2.example.com:9051 \
          --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt \
          -C mychannel -n transfer -c '{"Args":["setBalance","Alice","10000"]}'
    ...
    docker exec cli peer chaincode invoke -o orderer.example.com:7050 \
              ...
              --peerAddresses peer0.org2.example.com:9051 \
              --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt \
              -C mychannel -n data_swapper -c '{"Args":["set","path","'"${CURRENT_PATH}"'"]}'
    ...
    docker exec cli peer chaincode invoke -o orderer.example.com:7050 \
              ...
              --peerAddresses peer0.org2.example.com:9051 \
              --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt \
              -C mychannel -n transfer -c '{"Args":["register"]}'
    ...
    docker exec cli peer chaincode invoke -o orderer.example.com:7050 \
                        ...
                        --peerAddresses peer0.org2.example.com:9051 \
                        --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt \
                        -C mychannel -n broker -c '{"Args":["audit","mychannel", "transfer", "1"]}'
    ...
    docker exec cli peer chaincode invoke -o orderer.example.com:7050 \
              ...
              --peerAddresses peer0.org2.example.com:9051 \
              --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt \
              -C mychannel -n data_swapper -c '{"Args":["register"]}'
    sleep 5
    docker exec cli peer chaincode invoke -o orderer.example.com:7050 \
                          --tls \
                          --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem \
                          ...
                          --peerAddresses peer0.org2.example.com:9051 \
                          --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt \
                          -C mychannel -n broker -c '{"Args":["audit","mychannel", "data_swapper", "1"]}'
